...
{
    public partial class AltGiyim : System.Web.UI.Page
    {
        ...
        private void GetProductsAndPrices()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT TUrunID, TUrunAdi, TUrunFiyati, TResimPATH, TUrunKategori FROM TumUrunler where TUrunKategori=2", conn);
        ...
        protected void Button1AddToCard_Click(object sender, EventArgs e)
        {
