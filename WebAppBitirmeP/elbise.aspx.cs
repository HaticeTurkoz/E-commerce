...
{
    public partial class elbise : System.Web.UI.Page
    {
        ...
        private void GetProductsAndPrices()
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT TUrunID, TUrunAdi, TUrunFiyati, TResimPATH, TUrunKategori FROM TumUrunler where TUrunKategori=3", conn);
